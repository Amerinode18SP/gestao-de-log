...
export default function AlertasPage({ embedded = false }: { embedded?: boolean }) {
  ...
  return (
    <div style={{ minHeight: embedded ? 'auto' : '100vh', background: embedded ? 'transparent' : '#FAFAF8', fontFamily: 'var(--font-sans)', color: '#1A1916' }}>
      {!embedded && (
      ...
      <main style={{ padding: '28px 32px', maxWidth: '1000px', margin: '0 auto' }}>
        <div style={{ marginBottom: 16 }}>
          <h1 style={{ fontSize: '17px', fontWeight: 600, color: '#1A1916', margin: '0 0 2px' }}>Alertas</h1>
          <p style={{ fontSize: '12px', color: '#888780', margin: 0 }}>Limites de gasto e histórico de avisos</p>
        </div>
